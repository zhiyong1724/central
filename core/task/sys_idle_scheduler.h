...
*********************************************************************************************************************/
void sys_idle_scheduler_init(sys_idle_scheduler_t *idle_scheduler);
/*********************************************************************************************************************
* sys_idle_task_control_block_t初始化
* idle_task_control_block：sys_idle_task_control_block_t对象
* priority：优先级
*********************************************************************************************************************/
void sys_idle_task_control_block_init(sys_idle_scheduler_t *idle_scheduler, sys_idle_task_control_block_t *idle_task_control_block, int priority);
/*********************************************************************************************************************
* 时钟滴答
* idle_scheduler：sys_idle_scheduler_t对象
* ns：输入与上次tick的时间间隔
...
* return：错误码
*********************************************************************************************************************/
int sys_idle_scheduler_set_priority(sys_idle_scheduler_t *idle_scheduler, sys_idle_task_control_block_t *idle_task_control_block, int priority);
/*********************************************************************************************************************
* 获取当前运行的任务
* idle_scheduler：sys_idle_scheduler_t对象
*********************************************************************************************************************/
