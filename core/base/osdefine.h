...
#define OS_DEFAULT_TASK_STACK_SIZE                  4096               //堆栈大小
#endif

#ifndef OS_DEFAULT_TASK_PRIORITY
#define OS_DEFAULT_TASK_PRIORITY                    20               //默认任务优先级
#endif

#ifndef OS_DEFAULT_RTTASK_PRIORITY
#define OS_DEFAULT_RTTASK_PRIORITY                  32               //默认实时任务优先级
#endif
//信号量相关
